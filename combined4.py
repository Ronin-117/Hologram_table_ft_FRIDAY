...
holo_q=["open holomat","open holo mat","open hollow mat","open hollowmat","open hollowmap","open hollow map","open follow mat","open follow map","open format","open hola mat","open holo math","open hollow math","open follow math","open holo match","open hollow match","open follow match"]
    ...
    while True:
        ...
        if transcribed_text and "friday" in transcribed_text.lower():
            ...
            if user_query=="hello":
                ...
                continue
            elif "assemble suit" in user_query or "open mark 42 project" in user_query:
                if "assemble suit" in user_query:
